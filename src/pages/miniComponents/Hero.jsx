  ...
  return (
    <div className="w-full">
      ...
      sm:text-[1.75rem] md:text-[2.2rem] lg:text-[2.8rem] tracking-[15px]">
        <Typewriter
          words={["JUNIOR SOFTWARE ENGINEER AT DEFINEWAY TECHNOLOGIES PVT LTD", "FULLSTACK DEVELOPER"]}
          loop={50}
          cursor
          typeSpeed={70}
          deleteSpeed={50}
      ...
      items-center mt-4 md:mt-8 lg:mt-10">
        ...
        <Link to={user.leetCodeURL} target="_blank">
          <SiLeetcode className="text-pink-500 w-7 h-7" />
        </Link>
        <Link to={user.hackerRankURL} target="_blank">
          <FaHackerrank className="text-blue-800 w-7 h-7" />
        </Link>
      ...
      <p className="mt-8 text-xl tracking-[2px]">{user.objective}</p>
